<a class="product-card" data-type="product-card" href="{{route('products.read', $product->id)}}">
    ...
    <div class="product-card__body" data-type="product-card">
        ...
        <div class="view-more" data-type="product-card">
            <span class="view-more__icon" data-type="product-card">
                <svg data-type="product-card" xmlns="http://www.w3.org/2000/svg" width="8" height="14.525" viewBox="0 0 8 14.525"><g transform="translate(0 14.525) rotate(-90)"><path d="M13.276.216,7.263,6.229,1.251.215A.733.733,0,0,0,.214,1.253l6.53,6.532h0a.732.732,0,0,0,1.036,0l6.53-6.532A.733.733,0,1,0,13.276.216Z" fill="#fff"></path></g></svg>
            </span>
            {{__('View product')}}
        </div>
