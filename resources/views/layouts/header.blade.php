    ...
    <div class="container header__container">
        ...
        <div class="langs-dropdown" data-family="langs-dropdown">
            <button class="button langs-dropdown__button" data-family="langs-dropdown" type="button">
                <svg data-family="langs-dropdown" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15"><g data-family="langs-dropdown" transform="translate(10.544 3.902)"><path data-family="langs-dropdown" d="M369.374,137.952l-.051.022a16.7,16.7,0,0,1-3.529,1.116,11.917,11.917,0,0,1,0,4.924,16.66,16.66,0,0,1,3.53,1.11l.05.022a7.833,7.833,0,0,0,0-7.194Z" transform="translate(-365.792 -137.952)" fill="#fff"/></g><g transform="translate(5.37 10.324)"><path data-family="langs-dropdown" d="M186.112,358.712a10.84,10.84,0,0,0,2.129,3.821,10.825,10.825,0,0,0,2.129-3.821A16.25,16.25,0,0,0,186.112,358.712Z" transform="translate(-186.112 -358.572)" fill="#fff"/></g><g data-family="langs-dropdown" transform="translate(4.871 5.192)"><path data-family="langs-dropdown" d="M174.754,180.288a15.4,15.4,0,0,1-4.764,0,10.928,10.928,0,0,0,0,4.623,17.294,17.294,0,0,1,4.76,0A10.912,10.912,0,0,0,174.754,180.288Z" transform="translate(-169.744 -180.288)" fill="#fff"/></g><g data-family="langs-dropdown" transform="translate(5.37 0.715)"><path data-family="langs-dropdown" d="M188.241,23.456a10.836,10.836,0,0,0-2.129,3.822,16.292,16.292,0,0,0,4.258,0A10.845,10.845,0,0,0,188.241,23.456Z" transform="translate(-186.112 -23.456)" fill="#fff"/></g><g data-family="langs-dropdown" transform="translate(7.87)"><path data-family="langs-dropdown" d="M278.048,0a11.829,11.829,0,0,1,2.434,4.385,15.63,15.63,0,0,0,3.314-1.03A7.785,7.785,0,0,0,278.048,0Z" transform="translate(-278.048)" fill="#fff"/></g><g data-family="langs-dropdown" transform="translate(1.381)"><path data-family="langs-dropdown" d="M45.312,3.355a15.722,15.722,0,0,0,3.314,1.03A11.828,11.828,0,0,1,51.06,0,7.787,7.787,0,0,0,45.312,3.355Z" transform="translate(-45.312)" fill="#fff"/></g><g data-family="langs-dropdown" transform="translate(0 3.903)"><path data-family="langs-dropdown" d="M4.454,139.122a16.722,16.722,0,0,1-3.527-1.116l-.051-.022a7.826,7.826,0,0,0,0,7.194l.051-.022a16.522,16.522,0,0,1,3.529-1.11A11.9,11.9,0,0,1,4.454,139.122Z" transform="translate(0 -137.984)" fill="#fff"/></g><g data-family="langs-dropdown" transform="translate(1.381 10.616)"><path data-family="langs-dropdown" d="M48.626,368.16a15.626,15.626,0,0,0-3.314,1.029,7.787,7.787,0,0,0,5.748,3.355A11.832,11.832,0,0,1,48.626,368.16Z" transform="translate(-45.312 -368.16)" fill="#fff"/></g><g data-family="langs-dropdown" transform="translate(7.87 10.615)"><path data-family="langs-dropdown" d="M280.482,368.128a11.815,11.815,0,0,1-2.434,4.385,7.785,7.785,0,0,0,5.748-3.355A15.632,15.632,0,0,0,280.482,368.128Z" transform="translate(-278.048 -368.128)" fill="#fff"/></g></svg>
                @if ($locale == 'ru') Rus @endif
                @if ($locale == 'en') Eng @endif
                <svg data-family="langs-dropdown" class="langs-dropdown__icon" xmlns="http://www.w3.org/2000/svg" width="14.526" height="8" viewBox="0 0 14.526 8"><g data-family="langs-dropdown" transform="translate(0 -54.091)"><path data-family="langs-dropdown" d="M13.276,54.307,7.263,60.32,1.251,54.306A.733.733,0,0,0,.214,55.344l6.53,6.532h0a.732.732,0,0,0,1.036,0l6.53-6.532a.733.733,0,1,0-1.036-1.037Z" transform="translate(0 0)" fill="#fff"/></g></svg>
            </button>
        ...
        <nav class="main-navigation">
            <ul class="page-navigation">
                <li class="page-navigation__item">
                    <a class="page-navigation__link {{$route == 'home' ? 'current' : ''}}" href="{{route('home')}}">{{__('Home')}}</a>
                </li>
                <li class="page-navigation__item">
                    <a class="page-navigation__link {{$route == 'about' ? 'current' : ''}}" href="{{route('about')}}">{{__('About us')}}</a>
                </li>
                <li class="page-navigation__item">
                    <a class="page-navigation__link {{$route == 'products' || $route == 'products.read' ? 'current' : ''}}" href="{{route('products')}}">{{__('Products')}}</a>
                </li>
                <li class="page-navigation__item">
                    <a class="page-navigation__link {{$route == 'news' || $route == 'news.read' ? 'current' : ''}}" href="{{route('news')}}">{{__('Industry news')}}</a>
                </li>
                <li class="page-navigation__item">
                    <a class="page-navigation__link" href="{{route('contacts')}}#pharmacovigilance">{{__('Pharmacovigilance')}}</a>
                </li>
                <li class="page-navigation__item">
                    <a class="page-navigation__link {{$route == 'contacts' ? 'current' : ''}}" href="{{route('contacts')}}">{{__('Contacts')}}</a>
                </li>
            </ul>
        </nav>
    </div>
